...
## Install snort
Install winpcap
Install namp npcap (enable raw traffic)
Install snort

https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170


Copy preproc_rules and rules folders to C:\Snort
edit snort.conf
...
#var SO_RULE_PATH ../so_rules COMMENTED OUT
var PREPROC_RULE_PATH c:\Snort\preproc_rules

# Update WHITE_LIST_PATH and BLACK_LIST_PATH
...
# Setup the dynamic loaded libraries
...
#dynamicdetection directory /usr/local/lib/snort_dynamicrules COMMENTED OUT
...
whitelist $WHITE_LIST_PATH\whitelist.rules, \
   ...
   flip the / to \ in the snort.conf file
...
include $PREPROC_RULE_PATH\preprocessor.rules
 ...
 Run snort -W to see the interfaces
```
